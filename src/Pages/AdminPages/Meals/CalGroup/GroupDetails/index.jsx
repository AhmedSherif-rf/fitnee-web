...
import EditCalGroup from "../../../../../Shared/Modal/EditCalGroup";
    ...
    <React.Fragment>
      <Container className="adminDashBoardScrolling" fluid>
        <Row>
          <Col md={12}>
            <PageHeading
              headingText="Calories Group Details"
              categoryText=""
            ...
            >
              <div>
                <h3>Name: {categoryClassificationDetails?.name}</h3>
                <h3>
                  Min. Calories: {categoryClassificationDetails?.min_calories}
                </h3>
                <h3>
                  Max. Calories: {categoryClassificationDetails?.max_calories}
                </h3>
