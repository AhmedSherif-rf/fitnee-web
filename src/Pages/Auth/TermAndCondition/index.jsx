      ...
      <Row className="justify-content-center">
        <Col md={10}>
          ...
          <p align="justify">
            ...
            Company Name and/or its licensors own the intellectual property
            rights for all material on Website Name. All intellectual property
            rights are reserved. You may access this from Website Name for your
            ...
            rent or sub-license material from Website Name Reproduce, duplicate
            or copy material from Website Name Redistribute content from Website
            Name This Agreement shall begin on the date hereof. Parts of this
            website offer an opportunity for users to post and exchange opinions
            and information in certain areas of the website.
            <br />
            <br /> Company Name does not filter, edit, publish or review
            ...
            applicable laws, Company Name shall not be liable for the Comments
            ...
            Comments on this website. Company Name reserves the right to monitor
            ...
            <Col md={4}>
              <Link to="/">
                <OutlineBtn
                  ...
                  text={t("termAndCondition.doneText")}
                />
              </Link>
            </Col>
          </Row>
