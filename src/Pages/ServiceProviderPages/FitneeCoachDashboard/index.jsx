...
const Dashboard = () => {
  ...
  const fetchServiceProviderComments = useCallback(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [commentData, dispatch, hasNextComment, user]);
          ...
          <Card className="contentCard bg-transparent overflow-x-hidden">
            <Row>
              <Card className="BorderRadius contentCard  p-4">
                <div className="mb-2">
                  <Card className={` border-0 w-100 ${i18n.dir()}`}>
                    <CardBody className="p-0">
                      ...
                      ></div>
                      <p className="fs-5 my-2 fw-bold text-center w-100">
                    ...
                    <CardFooter className="border-0 text-black-custom">
                      <div className="h-100">
                        ...
                        <div
                          ...
                          className="fw-700 fs-6 text-secondary mb-0"
                        >
                          {user?.description}
                        </div>
                      </div>
