...
import { useAppsFlyerForPage } from "../../../hooks/useAppsFlyerForPage";
import {
...
const AppDownloadLink = () => {
  ...
  // Configure pages to exclude from AppsFlyer tracking
  // Add any page paths you don't want to trigger AppsFlyer from
  const excludedPages = [
    // Example: '/admin/dashboard',
    // Example: '/payment/processing',
  ];

  const { shouldShowAppsFlyerScript } = useAppsFlyerForPage(excludedPages);
  ...
  return (
    <>
      {/* Conditionally render AppsFlyer script based on previous page */}
