...
import { MEALS_INITIAL_VALUES } from "../../ValidationData/initialValue";
import {
  ...
  return (
    ...
    >
      <ModalHeader className="border-0">
        <b>{t("meals.addReceipe")}</b>
      </ModalHeader>
      <ModalBody className="px-4">
        <Formik
          initialValues={{ ...MEALS_INITIAL_VALUES }}
