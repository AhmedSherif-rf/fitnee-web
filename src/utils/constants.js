...
export const EXERCUSE_SUBSCRIPITION_PLAN_URL = "/execrise/exercise-subscription";
export const ADMIN_PLATFORM_FEEDBACK_LISTING_URL = "/admin/review/platform-reviews";
export const ADMIN_SERVICE_PROVIDER_FEEDBACK_LISTING_URL = "/admin/review/sp-reviews/";
export const GET_SERVICE_PROVIDER_COMMENTS_URL = "/service-provider/serviceProviderId/reviews/";
export const ADMIN_CHANGE_PLATFORM_FEEDBACK_STATUS_URL = "/admin/review/platform-review/feedbackId/";
export const ADMIN_CHANGE_SERVICE_PROVIDER_FEEDBACK_STATUS_URL = "/admin/review/sp-review/feedbackId/";
